...
class Ui_CustomerDialog(object):
    def setupUi(self, CustomerDialog):
        ...
        self.UpdateDates = QtWidgets.QPushButton(parent=CustomerDialog)
        self.UpdateDates.setObjectName("UpdateDates")
        self.BottomButtons.addWidget(self.UpdateDates)
    ...
    def retranslateUi(self, CustomerDialog):
        ...
        self.UpdateDates.setText(_translate("CustomerDialog", "Update Dates"))
