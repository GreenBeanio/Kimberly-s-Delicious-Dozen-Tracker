...
class Ui_ActivitiesDialog(object):
    def setupUi(self, ActivitiesDialog):
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(parent=ActivitiesDialog)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 331, 391))
        ...
        self.ActivityText = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.ActivityTable = QtWidgets.QTableView(parent=self.verticalLayoutWidget_3)
