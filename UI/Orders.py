...
class Ui_OrdersDialog(object):
    def setupUi(self, OrdersDialog):
        ...
        self.GetOrderDateButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        self.GetOrderDateButton.setObjectName("GetOrderDateButton")
        self.SelectionGrid.addWidget(self.GetOrderDateButton, 2, 3, 1, 1)
        self.GetPlannedDateButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.GetFinalDateButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
