...
class Ui_OrdersDialog(object):
    def setupUi(self, OrdersDialog):
        ...
        OrdersDialog.resize(559, 615)
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(parent=OrdersDialog)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 557, 611))
        ...
        self.PlannedLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        ...
        self.OrderDate = QtWidgets.QDateEdit(parent=self.verticalLayoutWidget_3)
        self.OrderDate.setObjectName("OrderDate")
        self.SelectionGrid.addWidget(self.OrderDate, 2, 2, 1, 1)
        self.OrderText_2 = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        self.OrderText_2.setObjectName("OrderText_2")
        self.SelectionGrid.addWidget(self.OrderText_2, 0, 2, 1, 1)
        self.CustomerLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.CustomerLabel.setObjectName("CustomerLabel")
        self.SelectionGrid.addWidget(self.CustomerLabel, 1, 0, 1, 1)
        self.PlannedDate = QtWidgets.QDateEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.OrderText = QtWidgets.QTextEdit(parent=self.verticalLayoutWidget_3)
        self.OrderText.setObjectName("OrderText")
        self.SelectionGrid.addWidget(self.OrderText, 7, 2, 1, 1)
        self.CustomerText = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.OrderNote = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.OrderNote.setObjectName("OrderNote")
        self.SelectionGrid.addWidget(self.OrderNote, 7, 0, 1, 1)
        self.FinalDate = QtWidgets.QDateEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.OrderLabel_2 = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.OrderLabel_2.setObjectName("OrderLabel_2")
        self.SelectionGrid.addWidget(self.OrderLabel_2, 2, 0, 1, 1)
        self.FinalLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.FinalLabel.setObjectName("FinalLabel")
        self.SelectionGrid.addWidget(self.FinalLabel, 4, 0, 1, 1)
        self.CustomersButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.SelectionGrid.addWidget(self.GetDateButton, 2, 3, 1, 1)
        ...
        self.OrderTable = QtWidgets.QTableView(parent=self.verticalLayoutWidget_3)
        ...
        OrdersDialog.setTabOrder(self.OrderText_2, self.CustomerText)
        ...
        OrdersDialog.setTabOrder(self.OrderDate, self.GetDateButton)
        OrdersDialog.setTabOrder(self.GetDateButton, self.PlannedDate)
        ...
        OrdersDialog.setTabOrder(self.StatusBox, self.OrderText)
        OrdersDialog.setTabOrder(self.OrderText, self.AddButton)
    ...
    def retranslateUi(self, OrdersDialog):
        ...
        self.GetDateButton.setText(_translate("OrdersDialog", "Get Date"))
